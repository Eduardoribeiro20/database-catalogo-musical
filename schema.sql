...
--UPDATE musicas
--SET nome_musica = 'Se Arrependimento Matasse (Ao Vivo)'
--WHERE id_musica = 10;

--UPDATE musicas
--SET nome_musica = 'Coisas Que Eu Não Vou Deixar de Ter (Ao Vivo)'
--WHERE id_musica = 11;

--UPDATE musicas
--SET nome_musica = 'Decidida a Me Esquecer (Ao Vivo)'
--WHERE id_musica = 12;
...
g.nome_genero
FROM musicas as m
JOIN generos AS g ON m.id_genero = g.id_genero